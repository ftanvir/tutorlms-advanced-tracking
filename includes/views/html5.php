...
<!-- <h2>fdhfhdf</h2> -->
    <div class="tutor-video-player">
        ...
        <video id="tutorlms-advanced-tracking" data-course-content-id="<?php esc_html_e($course_content_id); ?>" lesson-title="<?php echo esc_html( $lesson_title ); ?>" data-course-id="<?php echo esc_attr( $course_id ); ?>" data-video-id="<?php echo esc_attr( $video_info->source_video_id ); ?>" poster="<?php echo esc_url( $poster_url ); ?>" class="tutorPlayer" playsinline controls >
